			...
			func(ctx context.Context, p protocol.Protocol, index uint32) {
				...
				from = protocol.NewFromProtocol(
					...
					func(di *packets.DevInfo) storage.StorageProvider {
						...
						migratedPeer.stage2Inputs = append(migratedPeer.stage2Inputs, peerStage2{
							name: di.Name,
...
func (resumedPeer *ResumedPeer) MakeMigratable(
	...
	resumedPeer.stage4Inputs, deferFuncs, err = iutils.ConcurrentMap(
		stage3Inputs,
